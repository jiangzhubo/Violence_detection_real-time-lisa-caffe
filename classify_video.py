...
RGB_video_path = '/home/graymatics/Downloads/lisa-caffe-public-lstm_video_deploy/examples/LRCN_activity_recognition/testimage/'#'/home/graymatics/Downloads/lisa-caffe-public-lstm_video_deploy/examples/LRCN_activity_recognition/image/'#
if len(sys.argv) > 1:
  video = sys.argv[1]
else:
...
b = time.time()
print('12121212121111111111111111111111111111111111111111111111',b-a)
...
#RGB_singleFrame = './modelshahaha/single_frame_all_layers_hyb_RGB_iter_7800.caffemodel'
#flow_singleFrame = './modelshahaha/single_frame_all_layers_hyb_flow_iter_50000.caffemodel'
#RGB_lstm = './modelshahaha/RGB_lstm_model_iter_30000.caffemodel'
flow_lstm = './modelshahaha/snapshots_lstm_flow_iter_50000.caffemodel' #flow_lstm_model_iter_30000.caffemodel'
t = time.time()
print('1111111111111111111111111111111111111111',t-b)
...
q = time.time()
print('11111111111111111111111111111111111111',b-a,t-b,s-t,q-s)
