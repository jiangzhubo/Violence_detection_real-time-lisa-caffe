...
flow_frames = '/home/graymatics/Downloads/lisa-caffe-public-lstm_video_deploy/examples/LRCN_activity_recognition/flow_images/'
RGB_frames = '/home/graymatics/Downloads/lisa-caffe-public-lstm_video_deploy/examples/LRCN_activity_recognition/image/'
test_frames = 16 
train_frames = 16
test_buffer = 3
train_buffer = 16
...
class videoRead(caffe.Layer):
  ...
  def setup(self, bottom, top):
    ...
    for ix, line in enumerate(f_lines):
      print(line)
      #video2 = line.split(' ')[0].split('/')[2]
      video = line.split(' ')[0].split('/')[1]
      l = int(line.split(' ')[1])
      print(self.path_to_images)
      print(video)
      #print(video2)
      fm=self.path_to_images + video
      frames = glob2.glob('%s/*.jpg' %(fm))
      print(fm)
      print(frames)
